(function(){
  ...
  function orgLogoHtml(o,extraClass=''){
    ...
    return o?.logo_data
      ? `<span class="admin-client-avatar admin-client-logo ${extraClass}"><img src="${esc(o.logo_data)}" alt="Logo ${esc(o.name||'client')}"></span>`
...
const normalizedStatus=p=>p.status==='configuration_submitted'?'review_pending':p.status==='completed'?'unpublished':p.status;
  ...
  function renderOrganizations(){
    ...
    function adminCampaignRows(){return state.organizations.flatMap(o=>orgProjects(o).map(p=>({...p,organizationName:o.name,organizationId:o.id,organizationLogoData:o.logo_data||null})));}
