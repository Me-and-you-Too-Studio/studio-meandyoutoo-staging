(function(){
  ...
  async function toggleRead(id){
    ...
    try{
      const path=n.read_at?'/api/notifications/'+id+'/unread?audience=admin':'/api/notifications/'+id+'/read?audience=admin';
